...
import com.vmb.picker.videoorphoto.listener.OnCustomCameraInterfaceListener;
import com.vmb.picker.videoorphoto.listener.OnResultCallbackListener;
import com.vmb.picker.videoorphoto.listener.OnVideoSelectedPlayCallback;
...
import com.vmb.picker.videoorphoto.tools.DoubleUtils;
import com.vmb.picker.videoorphoto.tools.SdkVersionUtils;
...
public class PictureSelectionModel {
     ...
     * Use {@link#picture_Sina_style#picture_white_style#picture_QQ_style#picture_WeChat_style}
     */
    ...
    public PictureSelectionModel isShowIsCheck(boolean show) {
        selectionConfig.isShowIsCheck = show;
        return this;
    }
     ...
     * @param isPageStrategy
     * @param pageSize            Maximum number of pages { is preferably no less than 20}
     * @param isFilterInvalidFile Whether to filter invalid files {ome of the query performance is consumed,Especially on the Q version}
     * @return
     */
    ...
    /**
     * than how many KB images are not compressed
     *
     * @return
     */
    ...
    /**
     * Extra used with {+  File.separator + "CustomCamera" + File.separator}  to indicate that
     *
     ...
     * <p>
     * Activity Launch exit animation theme
     *
     * @return
     */
    ...
    public PictureSelectionModel setOriginalPath(String originalPath) {
        selectionConfig.originalPath = originalPath;
        return this;
    }
}
