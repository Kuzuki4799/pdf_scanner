package com.vmb.picker.videoorphoto.model;
...
import com.vmb.picker.videoorphoto.tools.ValueOf;
            ...
            if (data != null) {
                ...
                if (count > 0) {
                    ...
                    do {
                        ...
                        if ((!TextUtils.isEmpty(config.originalPath) && absolutePath.contains(config.originalPath)) || TextUtils.isEmpty(config.originalPath)) {
                            ...
                            System.out.println("folderName" + absolutePath);

                            long bucketId = data.getLong(data.getColumnIndexOrThrow(PROJECTION[9]));
                            long date = data.getLong(data.getColumnIndexOrThrow(PROJECTION[10])) * 1000;
