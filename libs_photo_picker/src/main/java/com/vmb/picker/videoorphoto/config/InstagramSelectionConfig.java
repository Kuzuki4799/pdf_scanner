...
import com.vmb.picker.videoorphoto.app.VMBGallery;
import com.vmb.picker.videoorphoto.app.PictureSelectorInstagramStyleActivity;
...
public final class InstagramSelectionConfig implements Parcelable {
    private int currentTheme = VMBGallery.THEME_STYLE_DEFAULT;
