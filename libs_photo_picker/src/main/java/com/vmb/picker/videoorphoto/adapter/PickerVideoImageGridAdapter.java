package com.vmb.picker.videoorphoto.adapter;
...
import com.vmb.picker.videoorphoto.tools.ToastUtils;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

public class PickerVideoImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PickerVideoImageGridAdapter(Context context, PictureSelectionConfig config) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == PictureConfig.TYPE_CAMERA) {
            ...
            if (config.isShowIsCheck && isLongClick)
...
//            }
            ...
            contentHolder.contentView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (imageSelectChangedListener != null && !isLongClick) {
                        isLongClick = true;
                        imageSelectChangedListener.onLongClick();
                        notifyDataSetChanged();
                    }
                    return false;
                }
