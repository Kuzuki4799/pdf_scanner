...
public interface OnPhotoEditorListener {
     ...
     */
    void onEditTextChangeListener(View defaultView, View rootView, String text, int colorCode);

    void onEditImageChangeListener(View defaultView, View imageView, String uri);
    ...
    void onViewTransform(ViewType viewType, View rootView, float x, float y, float scaleX, float scaleY, float rotation, int width, int height);
}
